...
```
If you are modelling an outcome for which logistic regression is apppropriate, transf_sum can similarly be inserted into the standard analysis. 
## Presenting the results
As we saw, the model summary is quite hard to interpret. (Although it is possible - additional functionality making this easier by making it possible to generate the different sets of pivot coordinates, wrap the repeated models, and summarise their output to follow!!)  
One way to get round this is to look at model predictions as the 
