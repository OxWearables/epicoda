...
One way to get round this is to look at model predictions. There are various options- we can look at predictions as we hold most of the composition fixed and vary the balance between the final two components. The plot_transfers function can do this: 
```{r}
